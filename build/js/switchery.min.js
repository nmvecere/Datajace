    ...
    require.register("switchery/switchery.js", function(exports, require, module) {
        ...
        Switchery.prototype.setPosition = function(clicked) {
            ...
            if (checked === true) {
                ...
                if (window.getComputedStyle) jack.style.left = 20 + "px";
                else jack.style.left = parseInt(switcher.currentStyle["width"]) - jack.offsetWidth + "px"; if (this.options.color) this.colorize();
                this.setSpeed()
            } else {
                jack.style.left = 0;
